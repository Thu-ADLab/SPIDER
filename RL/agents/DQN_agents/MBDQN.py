...
import numpy as np
from spider.RL.agents.Base_Agent import Base_Agent
from spider.RL.exploration_strategies.Epsilon_Greedy_Exploration import Epsilon_Greedy_Exploration
from spider.RL.utilities.data_structures.Replay_Buffer import Replay_Buffer

class MBDQN(Base_Agent):
    ...
    def calc_Q_value(self, state, meta_action_seq):
        pass

    def pick_action(self, state=None, imaginary_trajectories=None):
