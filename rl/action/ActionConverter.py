...
class TrajActionDecoder(nn.Module):
    ...
    '''
    def __init__(self, steps, dt, lon_range=(-80, 80), lat_range=(-80, 80)):
        super().__init__()
        self.steps = steps
        self.dt = dt
...
class TrajActionEncoder(nn.Module):
    ...
    '''
    def __init__(self, lon_range=(-80, 80), lat_range=(-80, 80)): #, relative=False):
        super().__init__()
        # self.steps = steps
        # self.dt = dt
